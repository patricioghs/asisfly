...
$router->post('/bookings/settings', [BookingController::class, 'saveSettings']);
$router->post('/bookings/resource', [BookingController::class, 'addResource']);
$router->post('/bookings/rule', [BookingController::class, 'addRule']);
$router->post('/bookings/rule/delete', [BookingController::class, 'deleteRule']);
$router->post('/bookings/block', [BookingController::class, 'addBlock']);
$router->post('/bookings', [BookingController::class, 'create']);
$router->post('/bookings/status', [BookingController::class, 'status']);
$router->get('/reserve', [BookingController::class, 'reserve']);
$router->post('/reserve', [BookingController::class, 'reserveStore']);
...
$router->get('/integrations/whatsapp-control', [IntegrationController::class, 'whatsappControl']);
$router->post('/integrations/whatsapp-control', [IntegrationController::class, 'saveWhatsAppController']);
$router->post('/integrations/whatsapp-control/disable', [IntegrationController::class, 'disableWhatsAppController']);
