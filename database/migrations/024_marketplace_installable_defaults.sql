...
WHERE ability_key IN ('core_omnichannel', 'crm', 'quotes', 'social_marketing', 'intelligence');
...
WHERE a.ability_key IN ('core_omnichannel', 'crm', 'quotes', 'social_marketing', 'intelligence')
