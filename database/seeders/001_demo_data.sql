...
('Dueño de empresa', JSON_ARRAY('company.manage','users.manage','assistant.manage','billing.manage')),
('Administrador', JSON_ARRAY('users.manage','assistant.manage','crm.manage','documents.manage')),
('Ejecutivo', JSON_ARRAY('crm.manage','quotes.manage','chat.use')),
('Analista', JSON_ARRAY('reports.view','documents.manage','chat.use')),
...
VALUES (1, 1, 'Admin AsisFly', 'admin@asisfly.ai', '$2y$10$demo.hash.replace.in.production', 'es_CL', 'America/Santiago');
...
VALUES (1, 'AsisFly', 'Cercano y ejecutivo', 'Español latino', 'Chile', 'CLP', 'Lunes a viernes 09:00 a 18:00', 'Equipo AsisFly', 'Pedir aprobacion antes de enviar correos, cotizaciones o mensajes comerciales.', '', 'Quedo atento/a', 'Reclamos, descuentos especiales, riesgos legales o clientes molestos.');
